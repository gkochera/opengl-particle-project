...
const char *WINDOWTITLE = { "OpenCL/OpenGL Particle System -- George Kochera" };
...
InitGlui( )
{
	glutInitWindowPosition( INIT_WINDOW_SIZE_X + 50, 0 );
...
InitLists( )
{
	...
	// It is centered at (400, 0.,-300.) with a radius of 300.
